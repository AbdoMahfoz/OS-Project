...
{
	//[[6] Shared Variables: Creation] createSharedObject() [Kernel Side]
...
{
	//[[6] Shared Variables: GetSize] getSizeOfSharedObject()
	// your code is here, remove the panic and write your code
...
{
	//[[6] Shared Variables: Get] getSharedObject() [Kernel Side]
	// your code is here, remove the panic and write your code
...
int freeSharedObject(int32 sharedObjectID, void *startVA)
{
	...
	//[] Free Shared Variable [Kernel Side]
	// your code is here, remove the panic and write your code
